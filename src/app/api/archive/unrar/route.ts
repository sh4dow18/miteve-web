export async function POST(request: Request) {
  ...
  const candidates = [
    `${base}/archive/unrar`,
    `${base.replace(":8084", ":8080")}/archive/unrar`,
    `${base.replace("/new-api", "")}/archive/unrar`,
  ];
  ...
  return new Response(JSON.stringify({ detail: "No static resource archive/unrar.", instance: "/archive/unrar", status: 404, title: "Not Found" }), {
    status: 404,
