export async function POST(request: Request) {
  ...
  const candidates = [`${base}/ffmpeg/1080p${qs}`, `${base.replace(":8084", ":8080")}/ffmpeg/1080p${qs}`, `${base.replace("/new-api", "")}/ffmpeg/1080p${qs}`];
  ...
  return new Response(JSON.stringify({ detail: "No static resource ffmpeg/1080p.", instance: "/ffmpeg/1080p", status: 404, title: "Not Found" }), {
    status: 404,
