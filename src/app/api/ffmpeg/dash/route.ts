export async function POST(request: Request) {
  ...
  const candidates = [`${base}/ffmpeg/dash${qs}`, `${base.replace(":8084", ":8080")}/ffmpeg/dash${qs}`, `${base.replace("/new-api", "")}/ffmpeg/dash${qs}`];
  ...
  return new Response(JSON.stringify({ detail: "No static resource ffmpeg/dash.", instance: "/ffmpeg/dash", status: 404, title: "Not Found" }), {
    status: 404,
