export async function POST(request: Request) {
  ...
  const candidates = [
    ...
    `${base.replace("/new-api", "")}/upload/folder`,
  ];
  ...
  return new Response(JSON.stringify({ detail: "No static resource upload/folder.", instance: "/upload/folder", status: 404, title: "Not Found" }), {
    status: 404,
