              ...
              {APP_INFO.technologies.frontend.map((tech, index) => (
                ...
                >
                  ...
                  <div className="relative flex items-center justify-center">
                    <span className="text-white group-hover:text-cyan-300 transition-colors text-center">
                      {tech}
                    </span>
                  </div>
                </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {APP_INFO.technologies.backend.map((tech, index) => (
                ...
                >
                  ...
                  <div className="relative flex items-center justify-center">
                    <span className="text-white group-hover:text-purple-300 transition-colors text-center">
                      {tech}
                    </span>
                  </div>
                </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {APP_INFO.technologies.deployment.map((tech, index) => (
                ...
                >
                  ...
                  <div className="relative flex items-center justify-center">
                    <span className="text-white group-hover:text-orange-300 transition-colors text-center">
                      {tech}
                    </span>
                  </div>
                </motion.div>
